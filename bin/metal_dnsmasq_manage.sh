...
domain=private,$MINIO_SUBNET.0/24,local
synth-domain=private,$MINIO_SUBNET.0/24,$HOST_TYPE-*
local=/private/
...
# the object/host-VLAN.privates are outside names
        ...
        echo "host-record=object-$MINIO_VLAN.private,$MINIO_SUBNET.$i" >> /etc/dnsmasq.d/minio.conf
        echo "host-record=object.$MINIO_VLAN.private,$MINIO_SUBNET.$i" >> /etc/dnsmasq.d/minio.conf
        echo "host-record=$HOST_TYPE-$i-$MINIO_VLAN.private,$MINIO_SUBNET.$i" >> /etc/dnsmasq.d/minio.conf
        echo "host-record=$HOST_TYPE-$i.$MINIO_VLAN.private,$MINIO_SUBNET.$i" >> /etc/dnsmasq.d/minio.conf
